...
JAVA_DEBUG_OPTS=" -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5011 "
...
#set JAVA_OPTS
JAVA_OPTS="-server -Xmx1024m  -Xms1024m -Xmn1024m  -Xss512k"
...
start()
{
    ...
    $run_cmd >> $LOG_DIR/soul-admin.log 2>&1 &
    echo $! > "$PID_FILE"
